...
const modules = [
  ...
  { title: 'Payroll', desc: 'Salary structures, periods, payslips', path: '/admin/hr/payroll', color: '#f59e0b' },
  ...
  { title: 'Learning', desc: 'Courses & enrollments', path: '/admin/hr/learning', color: '#f97316' },
  { title: 'Succession', desc: 'Succession plans & candidates', path: '/admin/hr/succession', color: '#6366f1' },
  { title: 'Offboarding', desc: 'Offboarding cases & tasks', path: '/admin/hr/offboarding', color: '#dc2626' },
...
export default function AdminHrDashboard() {
  ...
  return (
    <div>
      ...
      <p style={{ color: '#64748b', marginBottom: '1.5rem' }}>Manage your organization, employees, and HR operations</p>
