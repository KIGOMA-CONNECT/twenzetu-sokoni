...
const AdminAiAudit = lazy(() => import('./pages/admin/AdminAiAudit'));
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          <Route element={<RouteErrorBoundary fallbackTitle="Marketplace Error"><Outlet /></RouteErrorBoundary>}>
        ...
        <Route element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
          ...
          <Route element={<RouteErrorBoundary fallbackTitle="Consumer Error"><Outlet /></RouteErrorBoundary>}>
          ...
          <Route element={<RouteErrorBoundary fallbackTitle="Vendor Error"><Outlet /></RouteErrorBoundary>}>
          ...
          <Route element={<RouteErrorBoundary fallbackTitle="Admin Error"><Outlet /></RouteErrorBoundary>}>
            ...
            <Route path="/admin/ai/audit" element={<ProtectedRoute roles={STAFF_ADMIN_ROLES}><AdminAiAudit /></ProtectedRoute>} />
          ...
          <Route element={<RouteErrorBoundary fallbackTitle="Driver Error"><Outlet /></RouteErrorBoundary>}>
