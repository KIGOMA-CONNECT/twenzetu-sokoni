...
export interface CreateBranchProfileResult {
  readonly id: string;
}

export class CreateBranchProfileCommand implements ICommand<CreateBranchProfileResult> {
  public readonly _resultType?: CreateBranchProfileResult;
