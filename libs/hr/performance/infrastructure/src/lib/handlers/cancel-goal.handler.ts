...
import { CancelGoalCommand } from '@abms/hr-performance-application';
...
export class CancelGoalHandler extends TransactionalCommandHandler<CancelGoalCommand, void> {
  public constructor(
  ...
  protected async handle(command: CancelGoalCommand, ctx: ITransactionContext): Promise<void> {
