...
import { CompleteGoalCommand } from '@abms/hr-performance-application';
...
export class CompleteGoalHandler extends TransactionalCommandHandler<CompleteGoalCommand, void> {
  public constructor(
  ...
  protected async handle(command: CompleteGoalCommand, ctx: ITransactionContext): Promise<void> {
