...
import { TerminateEmployeeCommand } from '@abms/hr-application';
...
export class TerminateEmployeeHandler extends TransactionalCommandHandler<TerminateEmployeeCommand, void> {
  public constructor(
  ...
  protected async handle(command: TerminateEmployeeCommand, ctx: ITransactionContext): Promise<void> {
    ...
    const terminationDate = new Date(command.terminationDate);
