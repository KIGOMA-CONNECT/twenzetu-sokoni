...
import { CancelCourseEnrollmentCommand } from '@abms/hr-learning-application';
...
@Injectable()
@CommandHandler(CancelCourseEnrollmentCommand)
export class CancelCourseEnrollmentHandler extends TransactionalCommandHandler<
...
> {
  ...
  protected async handle(command: CancelCourseEnrollmentCommand, ctx: ITransactionContext): Promise<void> {
