...
import { MarkComplianceRecordOverdueCommand } from '@abms/hr-compliance-application';
...
@Injectable()
@CommandHandler(MarkComplianceRecordOverdueCommand)
export class MarkComplianceRecordOverdueHandler extends TransactionalCommandHandler<
...
> {
  ...
  protected async handle(command: MarkComplianceRecordOverdueCommand, ctx: ITransactionContext): Promise<void> {
