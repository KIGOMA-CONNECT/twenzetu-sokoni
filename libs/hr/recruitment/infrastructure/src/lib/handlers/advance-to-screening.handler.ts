...
import { AdvanceToScreeningCommand } from '@abms/hr-recruitment-application';
...
@Injectable()
@CommandHandler(AdvanceToScreeningCommand)
export class AdvanceToScreeningHandler extends TransactionalCommandHandler<AdvanceToScreeningCommand, void> {
  public constructor(
  ...
  protected async handle(command: AdvanceToScreeningCommand, ctx: ITransactionContext): Promise<void> {
