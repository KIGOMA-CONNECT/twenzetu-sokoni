...
import { MakeOfferCommand } from '@abms/hr-recruitment-application';
...
export class MakeOfferHandler extends TransactionalCommandHandler<MakeOfferCommand, void> {
  public constructor(
  ...
  protected async handle(command: MakeOfferCommand, ctx: ITransactionContext): Promise<void> {
