...
import { CashbackRuleOrmEntity } from './entities/cashback-rule-orm.entity';
...
export const MARKETPLACE_ENTITIES = [
  ...
  DisputeOrmEntity,
  SurgeRuleOrmEntity,
  CustomerPointsOrmEntity,
  CashbackRuleOrmEntity,
