...
export const METRIC_CATALOG: ReadonlyArray<MetricDefinition> = [
  ...
  {
    key: 'delivery_on_time_rate',
    name: 'Delivery On-Time Rate',
    category: 'DELIVERY',
    unit: 'RATE',
    description: 'Share of completed deliveries whose actual duration was within the estimated ETA.',
    source: 'deliveries.estimated_time_minutes vs updated_at - created_at',
  },
  {
    key: 'delivery_late_rate',
    name: 'Delivery Late Rate',
    category: 'DELIVERY',
    unit: 'RATE',
    description: 'Share of completed deliveries whose actual duration exceeded the estimated ETA.',
    source: 'deliveries.estimated_time_minutes vs updated_at - created_at',
  },
  {
    key: 'average_delivery_eta',
    name: 'Average Delivery ETA',
    category: 'DELIVERY',
    unit: 'COUNT',
    description: 'Average estimated delivery duration in minutes across deliveries.',
    source: 'deliveries.estimated_time_minutes',
  },
  {
    key: 'average_delivery_duration',
    name: 'Average Delivery Duration',
    category: 'DELIVERY',
    unit: 'COUNT',
    description: 'Average actual delivery duration in minutes for completed deliveries.',
    source: 'deliveries.updated_at - created_at',
  },
];
